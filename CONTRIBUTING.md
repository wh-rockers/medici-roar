...
Thank you for your interest in `medici-roar`, an open source project
administered by MicroEntropy.

Contributing to `medici-roar` is easy. In a few simple steps:
  ...
  * Sign the Contributor License Agreement below
...
```
  ...
  MicroEntropy, Inc. ("MicroEntropy"), You (as defined below) accept and
  agree to the following terms and conditions for Your present and
  future Contributions submitted to MicroEntropy. Except for the license
  granted in this Agreement to MicroEntropy and recipients of software
  distributed by MicroEntropy, You reserve all right, title, and interest
  ...
  1. Definitions
     ...
     Agreement with MicroEntropy.

     "Contribution" shall mean any original work of authorship,
     including any modifications or additions to an existing work, that
     is intentionally submitted by You to MicroEntropy for inclusion in,
     or documentation of, any of the products owned or managed by
     MicroEntropy ("Work"). For purposes of this definition, "submitted"
     means any form of electronic, verbal, or written communication
     sent to MicroEntropy or its representatives, including but not
     limited to communication or electronic mailing lists, source code
     control systems, and issue tracking systems that are managed by,
     or on behalf of, MicroEntropy for the purpose of discussing and
     improving the Work, but excluding communication that is
     conspicuously marked or otherwise designated in writing by You as
     "Not a Contribution."

  2. You Grant a Copyright License to MicroEntropy

     Subject to the terms and conditions of this Agreement, You hereby
     grant to MicroEntropy and recipients of software distributed by
     MicroEntropy, a perpetual, worldwide, non-exclusive, no-charge,
     royalty-free, irrevocable copyright license to reproduce, prepare
     derivative works of, publicly display, publicly perform,
     sublicense, and distribute Your Contributions and such derivative
     works under any license and without any restrictions.

  3. You Grant a Patent License to MicroEntropy

     Subject to the terms and conditions of this Agreement, You hereby
     grant to MicroEntropy and to recipients of software distributed by
     MicroEntropy a perpetual, worldwide, non-exclusive, no-charge,
     ...
     MicroEntropy under this Section applies only to those patent claims
  ...
  4. You Have the Right to Grant Licenses to MicroEntropy
  ...
  6. No Warranties or Conditions
     ...
     MicroEntropy acknowledges that unless required by applicable law or
  ...
  7. Submission on Behalf of Others
     ...
     may submit it to MicroEntropy separately from any Contribution,
  ...
  8. Agree to Notify of Change of Circumstances
     ...
     You agree to notify MicroEntropy of any facts or circumstances of
     which You become aware that would make these representations
     inaccurate in any respect. Email us at billcc.lv@hotmail.com.
```
